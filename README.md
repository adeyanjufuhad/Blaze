<p align="center">
  <a href="https://github.com/Fuhad-adeyanju09/Blaze">
    <picture>
      ...
      <img alt="Blaze - Pizza · Delivered" src="./assets/logo-dark.png" width="460">
    </picture>
  </a>
</p>
...
Blaze/
├── assets/
│   ├── logo-dark.png            # Official brand logo for Dark Mode (white text)
│   ├── logo-light.png           # Official brand logo for Light Mode (charcoal text)
│   ├── logo.png                 # Fallback brand logo lockup
│   └── logo-mark.png            # Precision brand squircle emblem (zero white corners)
├── client/                      # React 19 Frontend Application
│   ├── public/
│   │   ├── favicon.svg          # Minimalist brand favicon
│   │   ├── logo-dark.png        # Dark mode brand logo
│   │   ├── logo-light.png       # Light mode brand logo
